      ...
      <header className="border-b bg-white">
        <div className="container h-14 flex items-center justify-between gap-4">
          ...
          <nav className="flex items-center gap-1">
            <Item to="/">Inicio</Item>
            <Item to="/propiedades">Propiedades</Item>
            <Item to="/emprendimientos">Emprendimientos</Item>
            <Item to="/tasaciones">Tasaciones</Item>
            <Item to="/empresa">La Empresa</Item>
            <Item to="/contacto">Contacto</Item>
            {admin && (
              <div className="relative group">
                <button className="px-3 py-2 rounded-md text-gray-700 hover:bg-gray-50">Admin</button>
                <div className="absolute right-0 mt-1 w-56 rounded-xl border bg-white shadow-lg p-2 hidden group-hover:block">
